export class SettingsHandler {
  ...
  constructor(root, themeManager) {
    ...
    this.settingsCloseButton =
      this.settingsPanel.querySelector(".settings-close");
    this.notificationToggle =
      this.settingsPanel.querySelector("#notifications");
  ...
  setupEventListeners() {
    ...
    this.avatarsSelector?.addEventListener("change", (e) => {
      ...
      else console.warn("chatManager еще не загружен, попробуйте позже");
    });
  ...
  toggleSettings() {
    ...
    document.body.style.overflow = this.settingsPanel.classList.contains(
      "active"
    )
      ? "hidden"
      : "";
