...
function onCreateConversationError(errorText) {
  ...
  errorHandler.toggleErrorWindow(
    "ЭТОТ ПОЛЬЗОВАТЕЛЬ ИЛИ ВЫ ПРЕВЫСИЛИ МАКСИМУМ ЧАТОВ (30 чатов)."
  );
}
 ...
 * @param {*} convId
 */
export function tryLoadConversation(
  convId,
  callback = onLoadConversationByIdSuccess
) {
